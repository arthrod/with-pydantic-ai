...
/**
 * Renders the presentation header with navigation, slide indicator, and action controls.
 *
 * Renders back/forward navigation, a perform-research toggle, the current slide number indicator,
 * and action buttons to add, generate, speak, or delete slides.
 *
 * @param currentSlideIndex - Index of the currently active slide
 * @param setCurrentSlideIndex - Setter to update the current slide index
 * @param slides - Array of slides in the presentation
 * @param setSlides - Setter to update the slides array
 * @param performResearch - Whether automatic research is enabled for slide generation
 * @param setPerformResearch - Setter to toggle `performResearch`
 * @returns The header element containing slide navigation, slide count indicator, and action buttons
 */
