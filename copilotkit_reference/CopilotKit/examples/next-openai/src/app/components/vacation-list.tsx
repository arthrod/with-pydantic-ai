...
/**
 * Render the VacationList UI and manage new and visited destinations with Copilot integrations.
 *
 * Manages local state for `newDestinations` and `visitedDestinations`, registers Copilot actions
 * to add destinations, marks the travel document as readable for Copilot, configures chat
 * suggestions, and appends a welcome assistant message on mount.
 *
 * @returns The component's React element tree containing the header, VacationNotes, and two
 * DestinationTable sections for visited and new destinations.
 */
