...
/**
 * Renders the table header row for the destinations table.
 *
 * Contains four column headers — "Destination", "Selected", "Description", and "Activities" — each set with scope="col" and the component's standard styling classes.
 */
function Thead() {
  return (
    <thead>
...
/**
 * Renders a table of destinations with selectable rows and integrated Copilot actions.
 *
 * @param destinations - The array of destinations to display as rows.
 * @param heading - The table heading text; also used to derive Copilot action names.
 * @returns The rendered JSX element containing the heading and destination table.
 */
 ...
 *
 * @param str - The input string. Separators `-`, `_`, and space are removed and the following character is uppercased; the resulting string starts with a lowercase letter.
 * @returns The camelCased version of `str`
 */
