...
/**
 * Builds the system-role prompt used to instruct the assistant for a one-off Copilot task.
 *
 * @param contextString - Textual context to include inside the prompt (rendered in a fenced code block)
 * @param instructions - Task instructions to include inside the prompt (rendered in a fenced code block)
 * @returns A single string containing the formatted system message to be sent as the assistant's system prompt
 */
