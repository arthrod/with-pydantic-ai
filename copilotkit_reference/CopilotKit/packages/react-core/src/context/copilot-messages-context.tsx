...
/**
 * Retrieves the Copilot messages context for the calling component.
 *
 * @returns The current `CopilotMessagesContextParams` containing `messages`, `setMessages`, `suggestions`, and `setSuggestions`.
 * @throws Error if the hook is called outside a `<CopilotMessages>` provider.
 */
