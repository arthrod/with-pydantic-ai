...
/**
 * Retrieves the Copilot context for the calling component.
 *
 * @returns The current Copilot context parameters.
 * @throws Error if the hook is used outside of a `<CopilotKit>` provider.
 */
...
/**
 * Throws an error instructing the developer to wrap the app in a `<CopilotKit>` wrapper.
 *
 * @throws Error with the message "Remember to wrap your app in a `<CopilotKit> {...} </CopilotKit>` !!!"
 */
